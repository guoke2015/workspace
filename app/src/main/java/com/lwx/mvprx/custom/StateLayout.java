...
public class StateLayout extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        if (progressViewId != -1) {
            ...
            progressBar = progressView.findViewById(R.id.progress_wheel);
            progressTextView = progressView.findViewById(R.id.progressTextView);
        ...
        if (emptyDrawable != null) {
            ...
            emptyImageView.setImageResource(R.drawable.ic_empty_page);
        }
        addView(emptyView);
        /******************************************************************************************/
    ...
    public void showEmptyView(final String msg) {
    ...
    public void showErrorView(final String msg) {
        post(new Runnable() {
            @Override
            public void run() {
                onHideContentView();
    ...
    public void showProgressView(final String msg) {
        this.post(new Runnable() {
            @Override
            public void run() {
                onHideContentView();
